...
scs_m.props.context;
running the Xcos, it will take some time...
...
Xcos2CIC_quat( strtod( [Seq_data(1,1), Seq_data(1,2)] ), BIRDY_ATT.values, BIRDY_ATT.time, 'Birdy', 'SC_BODY_1', '/home/birdy/Software/DOCK_v1-4/Output/Dynamic_quat/Birdy-quaternion-150929-053444.txt');
